...
class UpdateInventory extends StatefulWidget {
  ...
  const UpdateInventory({Key key, this.shop, this.inventoryId})
      : super(key: key);
...
class _UpdateInventoryState extends State<UpdateInventory> {
  ...
  int logoindex, categoryId;

  String InventoryId, image_File = '';
  ...
  void getInventoryDetail() async {
    setState(() {
      isLoading = true;
    });

    Map<String, String> apiBodyObj = {};
    apiBodyObj['id'] = widget.inventoryId;
    ...
    if (response['status'] == 'success') {
      ...
      isLoading = false;
      InventoryId = json[0]['id'].toString();
      productName.text = json[0]['name'].toString();
      productDescription.text = json[0]['description'].toString();
      productPrice.text = json[0]['price'].toString();
      productStock.text = json[0]['stock'].toString();
      productTime.text = json[0]['shipment_days'].toString();
      productTax.text = json[0]['tax_rate'].toString();

      categoryId = json[0]['item_category'][0]['category_id'];

      List imageList = json[0]['image_thumb'];
      ...
      if (imageList.isNotEmpty) {
        ...
        for (int i = 0; i < imageList.length; i++) {
          isImage = true;
          setState(() {
            _apilogoUrlList.add(imageList[i]['image_thumb']);
            _logoList.add('');
            _logoUrlList.add('');
          });
        }
      ...
      _otherTitleControllers.text = json[0]['other']['option_name'].toString();
      List otherList = json[0]['other']['option'];
      if (otherList.isNotEmpty) {
        ...
        for (int i = 0; i < otherList.length; i++) {
          setState(() {
            ...
            TextEditingController _otherOptionController =
                TextEditingController();
            TextEditingController _priceOptionController =
                TextEditingController();
            _otherOptionController.text = otherList[i]['option'].toString();
            _priceOptionController.text = otherList[i]['price'].toString();
      ...
      _colorTitleControllers.text = json[0]['color']['option_name'].toString();
      List colorList = json[0]['color']['option'];
      if (colorList.isNotEmpty) {
        ...
        for (int i = 0; i < colorList.length; i++) {
          setState(() {
            ...
            TextEditingController _colorOptionController =
                TextEditingController();
            TextEditingController _priceOptionController =
                TextEditingController();
            _colorOptionController.text = colorList[i]['option'].toString();
            _priceOptionController.text = colorList[i]['price'].toString();
      ...
      _sizeTitleControllers.text = json[0]['size']['option_name'].toString();
      List sizeList = json[0]['size']['option'];
      if (sizeList.isNotEmpty) {
        ...
        for (int i = 0; i < sizeList.length; i++) {
          setState(() {
            _sizeOptionList.add('');
            TextEditingController _sizeOptionController =
                TextEditingController();
            TextEditingController _priceOptionController =
                TextEditingController();
            _sizeOptionController.text = sizeList[i]['option'].toString();
            _priceOptionController.text = sizeList[i]['price'].toString();
    ...
    if (response['status'] == 'success') {
      ...
      if (responseList.isNotEmpty) {
        ...
        for (int i = 0; i < categoryData.length; i++) {
          if (categoryData[i].id == categoryId) {
        ...
        for (int i = 0; i < getInventoryCategory.length; i++) {
          TextEditingController _inventoryCategoryController =
              TextEditingController();
  ...
  void updateInventory(name, description, price, item_category, stock,
      shipment_days, tax_rate, sizeObject, colorObject, otherObject) async {
    setState(() {
      isLoading = true;
    });
    ...
    Map<String, String> apiBodyObj = {};
    apiBodyObj['shop_id'] = widget.shop.id.toString();
    apiBodyObj['invent_id'] = InventoryId;
    apiBodyObj['name'] = name;
    ...
    Map<String, dynamic> response =
        await NetworkHelper.request('shop/UpdateInventory', apiBodyObj);
    ...
    if (response['status'] == 'success') {
      ...
      if (_logoList.length != 0) {
        for (int i = 0; i < _logoList.length; i++) {
          uploadImage(InventoryId, _logoList[i]);
        }
      }
  ...
  void deleteImage(id) async {
    ...
    Map<String, dynamic> response =
        await NetworkHelper.request('shop/RemoveInventoryImage', apiBodyObj);
        ...
        for (int i = 0; i < widget.shop.other.length; i++) {
          setState(() {
            ...
            _otherOptionController.text =
                widget.shop.other[i].option.toString();
      ...
      if (widget.shop.color.isNotEmpty) {
        ...
        for (int i = 0; i < widget.shop.color.length; i++) {
          setState(() {
            ...
            TextEditingController _priceOptionController =
                TextEditingController();
            _colorOptionController.text =
                widget.shop.color[i].option.toString();
                                                            ...
                                                            Container(
                                                                padding:
                                                                    const EdgeInsets
                                                                        ...
                                                                        0.0),
                                                                width:
                                                                    20.0, // you can adjust the width as you need
                                                                child:
                                                                    IconButton(
                                                                  icon: Icon(
                                                                      Icons
  ...
  Future<Null> _cropImage(String path, var selectedImage) async {
    ...
    if (croppedFile != null) {
      ...
      setState(() {
        ...
        _logoList.add(img2base64(imageFile));
                            ...
                            child: Container(
                              ...
                              child: FlatButton(
                                ...
                                shape: RoundedRectangleBorder(
                                  ...
                                  side: BorderSide(color: Color(0xFF8C8C8C)),
                                ),
                                child: Container(
                                    ...
                                    onTap: () {
                                      ...
                                      if (_apilogoUrlList[index] != '') {
                                        ...
                                        Widget continueButton = FlatButton(
                                          ...
                                          onPressed: () {
                                            Navigator.of(context).pop();
                                            deleteImage(getImageData[index]
                                                .id
                                                .toString());
                                          },
                                        );
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    CustomDropdownButton(
                                      ...
                                      hint: Container(child: Text('Category')),
                                      underline: Container(),
                                      onChanged: (val) {
                                        FocusScopeNode currentFocus =
                                            FocusScope.of(context);
                      ...
                      child: FlatButton(
                        onPressed: () async {
                          ...
                          if (isImage == false) {
                            ...
                            showSimpleDialog(context,
                                title: 'Attention', message: 'Price required.');
                          } else if (productStock.text == '') {
                            showSimpleDialog(context,
                                title: 'Attention', message: 'Stock required.');
                            ...
                            showSimpleDialog(context,
                                title: 'Attention', message: 'Time required.');
                          } else {
                            if (isSize == '1') {
                              if (_sizeOptionList.length > 0) {
                                for (int i = 0;
                                    i < _sizeOptionList.length;
                                    i++) {
                                  String sizeOption =
                                      _sizeOptionControllers[i].text;
                                  String sizePrice =
                                      _sizePriceControllers[i].text;
                                  if (sizeOption != '' || sizePrice != '') {
                                    var sizeObject =
                                        '{"option" : "$sizeOption","price" : "$sizePrice"}';
                                ...
                                sizeObject =
                                    '{"option_name" : "$sizeTitle","option" : $size}';
                                print(sizeObject);
                              } else {
                                String sizeTitle = _sizeTitleControllers.text;
                                var size = sizeList.toString();
                            ...
                            if (isColor == '1') {
                              if (_colorOptionList.length > 0) {
                                for (int i = 0;
                                    i < _colorOptionList.length;
                                    i++) {
                                  String colorOption =
                                      _colorOptionControllers[i].text;
                                  String colorPrice =
                                      _colorPriceControllers[i].text;
                                  if (colorOption != '' || colorPrice != '') {
                                    var colorObject =
                                        '{"option" : "$colorOption","price" : "$colorPrice"}';
                                ...
                                colorObject =
                                    '{"option_name" : "$colorTitle","option" : $color}';
                                print(colorObject);
                              } else {
                                String colorTitle = _colorTitleControllers.text;
                                var color = colorList.toString();
                            ...
                            if (isOther == '1') {
                              if (_otherOptionList.length > 0) {
                                for (int i = 0;
                                    i < _otherOptionList.length;
                                    i++) {
                                  String otherOption =
                                      _otherOptionControllers[i].text;
                                  String priceOption =
                                      _otherPriceControllers[i].text;
                                  if (otherOption != '' || priceOption != '') {
                                    var otherObject =
                                        '{"option" : "$otherOption","price" : "$priceOption"}';
                                ...
                                otherObject =
                                    '{"option_name" : "$otherTitle","option" : $other}';
                              } else {
                                String otherTitle = _otherTitleControllers.text;
                                var other = otherList.toString();
                                otherObject =
