...
class CouponQrRedeemScreen extends StatefulWidget {
  final Coupon coupon;
  final String purchaseId;

  const CouponQrRedeemScreen({Key key, this.coupon, this.purchaseId})
      : super(key: key);

  @override
  _CouponQrRedeemScreenState createState() => _CouponQrRedeemScreenState();
}

class _CouponQrRedeemScreenState extends State<CouponQrRedeemScreen> {
  ...
  void initState() {
    ...
    //qrObj['\"purchase_id\"'] = '\"'+widget.coupon.purchaseId+'\"';
...
//                  Divider(color: Colors.black),
                  ...
                  if (requireCustomerDetails == 1 &&
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          if (_isMerchant) redeemHandler(widget.purchaseId);
                        },
                        textColor: Colors.white,
                        padding: EdgeInsets.all(10.0),
                  ...
                  if (selfRedeemable == 1 && widget.coupon.redeemStatus == 0)
                    SizedBox(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          redeemHandler(widget.purchaseId);
                        },
                        textColor: Colors.white,
                        padding: EdgeInsets.all(10.0),
                        color: Colors.green[700],
