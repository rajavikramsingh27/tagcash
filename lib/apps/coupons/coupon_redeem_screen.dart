...
class CouponRedeemScreen extends StatefulWidget {
  ...
  const CouponRedeemScreen({Key key, this.coupon}) : super(key: key);

  @override
  _CouponRedeemScreenState createState() => _CouponRedeemScreenState();
}
...
class _CouponRedeemScreenState extends State<CouponRedeemScreen> {
  ...
  void initState() {
    super.initState();
    qrObj['\"action\"'] = '\"COUPON\"';
    qrObj['\"coupon_id\"'] = '\"' + widget.coupon.couponId + '\"';
    qrObj['\"purchase_id\"'] = '\"' + widget.coupon.id + '\"';
