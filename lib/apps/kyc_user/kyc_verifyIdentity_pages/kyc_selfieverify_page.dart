...
class KYCSelfieVerifyPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _KYCSelfieVerifyPageState();
  }
}

class _KYCSelfieVerifyPageState extends State<KYCSelfieVerifyPage> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  bool isLoading = false;
  var kycSelfiVerifyStatus;
  ...
  getKYCverifiedImage() async {
    ...
    apiBodyObj['verification_type'] = "selfi_holding_govt_id_with_date";
  ...
  onUploadPhotoClickHandler() async {
    ...
    apiBodyObj['upload_type'] = "selfi_holding_govt_id_with_date";
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            if (imageCapture) ...[
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Image.asset('assets/images/idprofile.png'),
                ),
              ),
              Positioned(
                bottom: 10,
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(kDefaultPadding),
                    child: Text(
                      getTranslated(context, "kyc_selfie_des"),
          ...
          if (kycSelfiVerifyStatus == "pending") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
          ...
          if (kycSelfiVerifyStatus == "unapproved") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
          ...
          if (kycSelfiVerifyStatus == "approved") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
