...
class KYCGovIdVerifyPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _KYCGovIdVerifyPageState();
  }
}

class _KYCGovIdVerifyPageState extends State<KYCGovIdVerifyPage> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  bool isLoading = false;
  var kycGovIdVerifyStatus;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            if (imageCapture) ...[
              ...
              Center(
                child: SizedBox(
                    height: 200,
                    width: 300,
                    child: Image.asset('assets/images/govplace.png')),
              ),
              Positioned(
                bottom: 10,
                right: 10,
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(kDefaultPadding),
                    child: Text(
                      getTranslated(context, "kyc_gov_id_des"),
          ...
          if (kycGovIdVerifyStatus == "pending") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
          ...
          if (kycGovIdVerifyStatus == "unapproved") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
          ...
          if (kycGovIdVerifyStatus == "approved") ...[
            Center(
              child: Padding(
                padding: const EdgeInsets.all(kDefaultPadding),
                child: Row(
