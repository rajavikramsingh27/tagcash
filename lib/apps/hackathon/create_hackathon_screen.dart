...
class _CreateHackathonScreenState extends State<CreateHackathonScreen> {
  ...
  static List<ScoreItem> scoringList = [
    ScoreItem(percentage: null, description: null)
  ];
  ...
  void initState() {
    ...
    scoringList = [ScoreItem(percentage: null, description: null)];
  ...
  void createHackathonHandler() async {
    ...
    Map<String, dynamic> response = await NetworkHelper.request(
        'HackathonMini/CreateHackathon', apiBodyObj);
...
class _ScoringTextFieldsState extends State<ScoringTextFields> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      if (_CreateHackathonScreenState.scoringList[widget.index].percentage !=
          null) {
        _percentageController.text = _CreateHackathonScreenState
            .scoringList[widget.index].percentage
            .toString();
      }
      _descriptionController.text =
          _CreateHackathonScreenState.scoringList[widget.index].description ??
              '';
    });
      ...
      children: [
        SizedBox(
          ...
          child: TextFormField(
            ...
            onChanged: (v) => _CreateHackathonScreenState
