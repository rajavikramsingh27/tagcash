...
class SendBankHistory extends StatefulWidget {
  final String walletId;

  const SendBankHistory({
    Key key,
    this.walletId,
  }) : super(key: key);

  @override
  _SendBankHistoryState createState() => _SendBankHistoryState();
}

class _SendBankHistoryState extends State<SendBankHistory> {
