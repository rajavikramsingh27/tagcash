...
class AgentPickLocationScreen extends StatefulWidget {
  @override
  _AgentPickLocationScreenState createState() =>
      _AgentPickLocationScreenState();
}

class _AgentPickLocationScreenState extends State<AgentPickLocationScreen> {
