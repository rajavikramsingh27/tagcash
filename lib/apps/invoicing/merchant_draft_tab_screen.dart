...
class MerchantDraftTabScreen extends StatefulWidget {
  @override
  _MearchantDraftTabScreenState createState() =>
      _MearchantDraftTabScreenState();
}

class _MearchantDraftTabScreenState extends State<MerchantDraftTabScreen> {
                  ...
                  return snapshot.hasData
                      ? ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                                child: Container(
                                  child: snapshot.data[index].status == 'Draft'
                                      ? Column(
                                          children: [
                                            Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            getTranslated(context, 'invoice_nodraftinvoice'),
                            style: TextStyle(
                        ...
                        Container(
                          child: Text(
                            getTranslated(context, 'invoice_appeardraftinvoice'),
