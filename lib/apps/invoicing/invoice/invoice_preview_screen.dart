...
class InvoicePreviewScreen extends StatefulWidget {
  String invoice_id, invoice, amount_due, due_on, phone, subtotal, totalamount, type;
  String customerId, customerName, customerEmail, customerAddress1, customerAddress2, customerCity, customerZipcode,
      customerState, customerCountry;
  List<AddItem> getData = new List<AddItem>();
  List<Tax_total> setTaxData = new List<Tax_total>();


  InvoicePreviewScreen({Key key, this.invoice_id, this.invoice, this.amount_due, this.due_on,
  this.customerId, this.customerName, this.customerEmail, this.customerAddress1, this.customerAddress2,
    this.customerCity, this.customerZipcode, this.customerState, this.customerCountry, this.phone, this.getData,
    this.subtotal, this.setTaxData, this.totalamount, this.type}) : super(key: key);

  @override
  _InvoicePreviewScreenState createState() => _InvoicePreviewScreenState(invoice_id, invoice, amount_due, due_on, customerId, customerName, customerEmail,
      customerAddress1, customerAddress2, customerCity, customerZipcode, customerState, customerCountry, phone, getData, subtotal, setTaxData, totalamount, type);
}
...
class _InvoicePreviewScreenState extends State<InvoicePreviewScreen> {
  ...
  _InvoicePreviewScreenState(String invoice_id, String invoice, String amount_due, String due_on, String customerId, String customerName,
      String customerEmail, String customerAddress1, String customerAddress2, String customerCity, String customerZipcode, String customerState, String customerCountry,
      String phone, List<AddItem> getData, String subtotal, List<Tax_total> setTaxData, String totalamount, String type) {
  ...
  String company = '', address1 = '', address2 = '', city = '', zipcode = '', country = '', country_id = '', state = '',  state_id = '';
  String main = '', mobile = '', website = '', items = '', amount = '';
  ...
  void getConfig() async {
    ...
    if (response['status'] == 'success') {
      ...
      setState(() {
        ...
        country_id = jsonn[0]['address'][0]['country']['addressCountryId'].toString();
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                            new MaterialPageRoute(builder: (context) => InvoiceCustomizationScreen())
                  ...
                  child: ButtonTheme(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if(type == 'new'){
                          Navigator.of(context).push(
                              new MaterialPageRoute(builder: (context) => SendInvoiceScreen(invoice_id:invoice_id, customer_email: customerEmail, invoice_no: '', total_amout: total_amount.toStringAsFixed(2), send_type: 'new'))
                          ).then((val)=>val?Navigator.pop(context,true):null);
                        }else{
                          Navigator.of(context).push(
                              new MaterialPageRoute(builder: (context) => SendInvoiceScreen(invoice_id:invoice_id, customer_email: customerEmail, invoice_no: invoice, total_amout: total_amount.toStringAsFixed(2), send_type: 'edit',))
                          ).then((val)=>val?Navigator.pop(context,true):null);
                        }
