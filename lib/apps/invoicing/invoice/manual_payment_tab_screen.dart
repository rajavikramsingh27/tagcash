...
class ManualPaymentTabScreen extends StatefulWidget {
  final String invoice_id;

  ManualPaymentTabScreen(this.invoice_id);

  @override
  _ManualPaymentTabScreenState createState() =>
      _ManualPaymentTabScreenState(invoice_id);
}

class _ManualPaymentTabScreenState extends State<ManualPaymentTabScreen> {
  String invoice_id;
  ...
  _ManualPaymentTabScreenState(String invoice_id) {
          ...
          children: [
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return _PaymentAccountDialog(
                                ...
                                onTextChanged: (cities) {
                                  selectedefault = cities;
                                  var str_Name = selectedefault.reduce(
                                      (value, element) => value + element);
                                  setState(() {
                                    payment_account = str_Name;
                                    if (payment_account == 'Cash on Hand') {
                                      pay_account_index = 0;
                                      pay_account_name = 'Cash on Hand';
                                      pay_account_value = 'cash';
                                      pay_account_namelocal = 'Cash on Hand';
                                      pay_account_indexlocal = 0;
                                    } else if (payment_account ==
                                        'Shareholder Loan') {
                                      pay_account_index = 1;
                                      pay_account_name = 'Shareholder Loan';
                                      pay_account_value = 'shareholder';
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: new InputDecoration(labelText: 'Memo/Notes'),
              ),
            ),
            SizedBox(height: 10),
            Container(
