...
class AddAddressScreen extends StatefulWidget {
  ...
  @override
  _AddAddessScreenState createState() => _AddAddessScreenState(addressed);
}

class _AddAddessScreenState extends State<AddAddressScreen> {
  var addressed;
  ...
  _AddAddessScreenState(var addressed) {
  ...
  void initState() {
    ...
    setState(() {
      if (addressed == null || addressed == 'size=0') {
        print(addressed);
      } else {
        _address1Controller.text = addressed['address1'];
        _address2Controller.text = addressed['address2'];
        _selectcountryController.text = addressed['country']['addressCountry'];
        _selectstateController.text = addressed['state']['addressState'];
        _selectcityController.text = addressed['city'];
        _postalcodeController.text = addressed['zipCode'];
        countryId = addressed['country']['addressCountryId'];
        stateId = addressed['state']['addressStateId'];
      }
    });
  }
...
addStringToSF(
  ...
  prefs.setString('address_address_1', address_1);
  prefs.setString('address_address_2', address_2);
  prefs.setString('address_country', country);
  prefs.setString('address_country_id', country_id);
  prefs.setString('address_state', state);
  prefs.setString('address_state_id', state_id);
  prefs.setString('address_city', city);
  prefs.setString('address_postal_code', postal_code);
}
