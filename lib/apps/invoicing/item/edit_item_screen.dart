...
class EditItemScreen extends StatefulWidget {
  final String user_id, name, desc, price, tax, income_account, txt_id;
  ...
  _EditItemScreenState createState() => _EditItemScreenState(
      user_id, name, desc, price, tax, income_account, txt_id, getTaxData);
}

class _EditItemScreenState extends State<EditItemScreen>
    with SingleTickerProviderStateMixin {

  String user_id, name, desc, price, tax, income_account, txt_id;
  List<Tax> getTaxData;
  var dialog_name = 'Consulting Income';
  var dialog_value = 'consulting_income';

  _EditItemScreenState(String user_id, String name, String desc, String price,
      String tax, String income_account, String txt_id, List<Tax> getTaxData) {
    ...
    setState(() {
      if(getTaxData.length != 0){
        for(int i=0; i<getTaxData.length; i++){
         /* selectedtaxes.add(getTaxData[i].name);
          selectedtaxesid.add(getTaxData[i].id);*/
          Tax tax = new Tax();
      ...
      _item_nameIdController.selection = TextSelection.fromPosition(TextPosition(offset: _item_nameIdController.text.length));
      _item_descController.selection = TextSelection.fromPosition(TextPosition(offset: _item_descController.text.length));
      _item_priceController.selection = TextSelection.fromPosition(TextPosition(offset: _item_priceController.text.length));
